      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-16 px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div className="space-y-8 rounded-3xl border border-emerald-300/20 bg-slate-950/60 p-8 shadow-2xl backdrop-blur">
            <span className="inline-flex w-fit items-center rounded-full border border-emerald-300/40 bg-emerald-400/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.32em] text-emerald-100">
              {t("services.badge")}
            </span>
          ...
          <div className="space-y-8">
            {list.map((service, index) => (
              <article
                ...
                className="flex flex-col gap-4 rounded-3xl border border-emerald-300/20 bg-slate-950/60 p-6 text-white shadow-xl backdrop-blur transition-transform duration-500 hover:-translate-y-1"
              >
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl border border-emerald-300/40 bg-emerald-400/10 text-emerald-200">
